        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                $.each(data.dataList,function (i,n) {
                    ...
                    html+='<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'particulars?id='+n.id+'\';">'+n.fullname+'</a></td>';
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="height: 80px;">
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <button type="button" class="btn btn-default" id="searBtn">查询</button>
...
<%--							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='particulars?id=E950F94C37CC4E5996CC9FE474471016';">马云先生</a></td>--%>
<%--							<td>动力节点</td>--%>
<%--							<td>010-84846003</td>--%>
<%--							<td>12345678901</td>--%>
<%--							<td>广告</td>--%>
